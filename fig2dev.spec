...
Version  : 5.10.2021
Release  : 401
URL      : file:///aot/build/clearlinux/packages/fig2dev/fig2dev-v5.10.2021.tar.gz
Source0  : file:///aot/build/clearlinux/packages/fig2dev/fig2dev-v5.10.2021.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: fig2dev-bin = %{version}-%{release}
Requires: fig2dev-data = %{version}-%{release}
Requires: fig2dev-man = %{version}-%{release}
...
%package bin
Summary: bin components for the fig2dev package.
Group: Binaries
Requires: fig2dev-data = %{version}-%{release}

%description bin
bin components for the fig2dev package.


%package data
Summary: data components for the fig2dev package.
Group: Data

%description data
data components for the fig2dev package.


%package man
Summary: man components for the fig2dev package.
Group: Default

%description man
man components for the fig2dev package.


%prep
%setup -q -n fig2dev
cd %{_builddir}/fig2dev
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638326886
...
/usr/share/man/man1/fig2dev.1
/usr/share/man/man1/fig2ps2tex.1
/usr/share/man/man1/pic2tpic.1
