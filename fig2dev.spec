...
Version  : 3.2.8
Release  : 2
URL      : file:///aot/build/clearlinux/packages/fig2dev/fig2dev-v3.2.8.tar.gz
Source0  : file:///aot/build/clearlinux/packages/fig2dev/fig2dev-v3.2.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628493975
